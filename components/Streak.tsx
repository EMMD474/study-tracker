...
const Streak: React.FC<StreakProps> = ({
  ...
  return (
    <div
      className="relative w-full max-w-xs rounded-2xl p-6 overflow-hidden"
      style={{
        background: '#111111',
    ...
    >
      ...
      <div className="flex items-center justify-between mb-5">
        <span
          ...
          style={{ fontSize: '10px', color: '#555', letterSpacing: '0.12em' }}
        >
          Consistency Streak
        </span>
        <span
      ...
      <div className="mb-5">
        <div
          ...
          style={{ fontSize: '9px', color: '#3a3a3a', letterSpacing: '0.12em' }}
        >
          Last 7 days
        </div>
        <div className="flex gap-1.5">
          {activity.map((day, i) => (
            <div key={i} className="flex flex-col items-center gap-1.5">
              <div
                style={{
                  ...
                  background: day
                    ...
                    : '#1c1c1c',
                  border: day ? 'none' : '1px solid rgba(255,255,255,0.04)',
                  boxShadow: day
                    ? isToday(i)
              ...
              />
              <span style={{ fontSize: '9px', color: '#333', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                {DAY_LABELS[i]}
              </span>
            </div>
          ))}
      ...
      <div className="flex items-center justify-between">
        <div className="flex flex-col gap-0.5">
          <span className="uppercase" style={{ fontSize: '9px', color: '#333', letterSpacing: '0.12em' }}>
            Best streak
          </span>
          <div className="flex items-baseline gap-1">
            <span style={{ fontFamily: "'Fraunces', serif", fontSize: '22px', fontWeight: 700, color: '#c8a96e', lineHeight: 1, letterSpacing: '-0.5px' }}>
              {longest}
            </span>
            <span style={{ fontSize: '9px', color: '#444', textTransform: 'uppercase', letterSpacing: '0.08em' }}>
              days
            </span>
          </div>
        </div>
